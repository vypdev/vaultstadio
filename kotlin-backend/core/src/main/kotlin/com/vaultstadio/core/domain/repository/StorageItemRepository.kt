/**
 * VaultStadio Storage Item Repository
 *
 * Interface for storage item persistence operations.
 * Implementations can use different databases (PostgreSQL, SQLite, etc.)
 */
...
data class StorageItemQuery(
    ...
    /**
     * When true, filter by [parentId]: exact match if non-null, or parent_id IS NULL for root.
     * When false, do not filter by parent (e.g. for trash, starred, recent).
     */
