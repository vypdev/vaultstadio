...
interface GetCollaborationSessionUseCase {
    suspend operator fun invoke(sessionId: String): ApiResult<CollaborationSession>
}
...
class GetCollaborationSessionUseCaseImpl(
    ...
    override suspend operator fun invoke(sessionId: String): ApiResult<CollaborationSession> =
