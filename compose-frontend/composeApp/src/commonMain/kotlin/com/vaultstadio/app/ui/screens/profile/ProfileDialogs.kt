/**
 * VaultStadio Profile Dialogs
 *
 * Dialog components for the Profile screen.
 */
...
private const val SAMPLE_USERNAME = "john.doe"
...
@Preview
@Composable
internal fun EditProfileDialogPreview() {
    VaultStadioPreview {
        EditProfileDialog(
            currentUsername = SAMPLE_USERNAME,
            isSaving = false,
            onSave = {},
            onDismiss = {},
        )
