...
interface GetVersionUseCase {
    suspend operator fun invoke(itemId: String, versionNumber: Int): ApiResult<FileVersion>
}
...
class GetVersionUseCaseImpl(
    ...
    override suspend operator fun invoke(itemId: String, versionNumber: Int): ApiResult<FileVersion> =
