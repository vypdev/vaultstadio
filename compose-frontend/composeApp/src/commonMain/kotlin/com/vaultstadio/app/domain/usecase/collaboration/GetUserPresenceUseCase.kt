...
interface GetUserPresenceUseCase {
    suspend operator fun invoke(userIds: List<String>): ApiResult<List<UserPresence>>
}
...
class GetUserPresenceUseCaseImpl(
    ...
    override suspend operator fun invoke(userIds: List<String>): ApiResult<List<UserPresence>> =
