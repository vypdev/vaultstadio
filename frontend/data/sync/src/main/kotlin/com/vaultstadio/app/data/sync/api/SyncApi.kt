...
package com.vaultstadio.app.data.sync.api
...
import com.vaultstadio.app.data.sync.dto.ResolveConflictRequestDTO
import com.vaultstadio.app.data.sync.dto.SyncConflictDTO
import com.vaultstadio.app.data.sync.dto.SyncDeviceDTO
import com.vaultstadio.app.data.sync.dto.SyncRequestDTO
import com.vaultstadio.app.data.sync.dto.SyncResponseDTO
...
class SyncApi(client: HttpClient) : BaseApi(client) {
    ...
    suspend fun resolveConflict(conflictId: String, resolution: String): ApiResult<Map<String, String>> =
        post("/api/v1/sync/conflicts/$conflictId/resolve", ResolveConflictRequestDTO(resolution))
}
