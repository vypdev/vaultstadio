...
interface UpdateUserStatusUseCase {
    suspend operator fun invoke(userId: String, status: UserStatus): ApiResult<AdminUser>
}
...
class UpdateUserStatusUseCaseImpl(
    ...
    override suspend operator fun invoke(userId: String, status: UserStatus): ApiResult<AdminUser> =
