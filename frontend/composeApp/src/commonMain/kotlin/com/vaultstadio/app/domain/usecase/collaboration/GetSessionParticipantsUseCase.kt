...
interface GetSessionParticipantsUseCase {
    suspend operator fun invoke(sessionId: String): ApiResult<List<CollaborationParticipant>>
}
...
class GetSessionParticipantsUseCaseImpl(
    ...
    override suspend operator fun invoke(sessionId: String): ApiResult<List<CollaborationParticipant>> =
