...
fun main() {
    startKoin {
        modules(runtimeModules("http://localhost:8080/api") + activityModule + adminModule + authModule + aiModule + collaborationModule + configModule + shareModule + pluginModule + storageModule + metadataModule + syncModule + federationModule + versionModule)
    }
    application {
        Window(
