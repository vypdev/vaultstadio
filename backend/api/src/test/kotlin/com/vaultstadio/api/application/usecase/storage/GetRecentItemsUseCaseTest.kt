/**
 * GetRecentItemsUseCase unit tests.
 */
...
class GetRecentItemsUseCaseTest {

    private val storageService: StorageService = mockk()
    private val useCase = GetRecentItemsUseCaseImpl(storageService)
    ...
    fun invokeDelegatesToStorageServiceAndReturnsRightList() = runTest {
        ...
        coEvery { storageService.getRecentItems("user-1", 20) } returns Either.Right(items)
    ...
    fun invokeReturnsLeftWhenStorageServiceReturnsLeft() = runTest {
        coEvery { storageService.getRecentItems(any(), any()) } returns
