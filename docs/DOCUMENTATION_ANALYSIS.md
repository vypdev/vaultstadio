...
| Aspect | Evidence |
|--------|----------|
| **Central navigation** | [docs/INDEX.md](INDEX.md) provides “I want to…” quick links, tables by audience (Developers, Operators, Frontend Devs), and a clear doc structure. |
...
| **Visual architecture** | [ARCHITECTURE.md](ARCHITECTURE.md) uses ASCII diagrams for backend, frontend, versioning, sync, federation, collaboration, WebDAV/S3. |
...
| Aspect | Evidence |
|--------|----------|
| **Explicit AI guidelines** | [AI_CODING_GUIDELINES.md](AI_CODING_GUIDELINES.md) defines role, priorities, “what to avoid”, “what to always do”, and references to rules/architecture. |
...
- **Issue**: [docs/ACTION_PLAN.md](ACTION_PLAN.md) is referenced in four places but **the file does not exist**:
